...
if(isset($_POST['search']))
{
    ...
    $search=$db->prepare("select * from Table_siswa where id_siswa=? or nama_siswa=? or sekolah=? or motivasi=?");
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php foreach ($data_siswa as $key):?>
                            ...
                            <td><a class="btn btn-light" href="index.php?delete=&id_siswa=<?php echo $key['id_siswa']?>">Delete</a> | <a class="btn btn-light" href="edit.php?id_siswa=<?php echo $key['id_siswa']; ?>">Edit</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
